...
import { fetchCampuses, fetchStudents, updateFirstName, updateLastName, updateTheEmail, updatePicture, updateGPA, updatePhone } from '../store'
...
class Profile extends Component {
    constructor(){
        ...
        this.saveGPA = this.saveGPA.bind(this)
    ...
    savePhone(value){
        this.props.saveThePhone(value, this.props.id)
    }
    saveGPA(value){
        this.props.saveTheGPA(value, this.props.id)
    }
    saveImage(value){
        this.props.savePicture(value, this.props.id)
    }
    cancel(){
                   ...
                   <div className="main-body">
                    <nav aria-label="breadcrumb" className="main-breadcrumb">
                      <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page"> {student ? student.firstName : 'no name'}</li>
                      </ol>
                    </nav>    
                        ...
                        <div className="card">
                          <div className="card-body">
                            <div className="d-flex flex-column align-items-center text-center">
                              <img src={student.imageUrl} alt="Admin" className="rounded-circle" width="150" />
                              <div className="mt-3">
                          ...
                          <div className="card-body">
                            ...
                            <div className="row">
                              ...
                              <EasyEdit
                                    ...
                                    cancelButtonLabel="Cancel Me"
                                    attributes={{ name: "awesome-input", id: 1}}
                                    instructions="Update students's email address"
                            ...
                            <div className="row">
                              ...
                              <EasyEdit
                                    ...
                                    cancelButtonLabel="Cancel Me"
                                    attributes={{ name: "awesome-input", id: 1}}
                                    instructions="Update students's phone number"
                            ...
                            <div className="row">
                              ...
                              <EasyEdit
                                    ...
                                    cancelButtonLabel="Cancel Me"
                                    attributes={{ name: "awesome-input", id: 1}}
                                    instructions="Update students's GPA"
                            ...
                            <div className="row">
                              <div className="col-sm-3">
                                <h6 className="mb-0">Profile Picture URL</h6>
                              </div>
                              <div className="col-sm-9 text-secondary">
                              <EasyEdit
                                    type="text"
                                    ...
                                    cancelButtonLabel="Cancel Me"
                                    attributes={{ name: "awesome-input", id: 1}}
                                    instructions="Update students's profile picture"
...
const mapDispatch = (dispatch) => {
    return {
        ...
        saveThePhone: (value, id) => dispatch(updatePhone({ value: value, id: id })),
        saveTheGPA: (value, id) => dispatch(updateGPA({ value: value, id: id })),
        savePicture: (value, id) => dispatch(updatePicture({ value: value, id: id }))
    }
}
